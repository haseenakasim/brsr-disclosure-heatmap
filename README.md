...
## The 12 KPIs We Are Scoring
1. % women in workforce
2. % women in senior management
3. CEO-to-median worker pay ratio disclosed?
4. Anti-corruption training hours (numeric?)
5. Human rights review conducted (Y/N)
6. % differently-abled employees
7. Scope 1 emissions (numeric?)
8. Scope 2 emissions (numeric?)
9. Water consumption (numeric?)
10. Waste generated (numeric?)
11. CSR expenditure vs statutory obligation
12. Supplier ESG assessment conducted (Y/N)
